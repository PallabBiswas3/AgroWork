...
const homeEn = {
  ...
  about: {
    title: 'About AgroWork',
    subtitle: 'AI-driven decision support for sustainable, profitable farming',
    p1: 'AgroWork is a unified platform that brings soil insights, crop guidance, disease detection, weather intelligence, and financial planning together—so you can make faster, better decisions on the field.',
    point1: 'Data-backed crop and input recommendations personalized for your farm',
    point2: 'Actionable soil and weather insights to optimize yield and resources',
    point3: 'Conversational assistance in your language for everyday farm queries',
    card1_title: 'AI Assistance',
    card1_desc: 'Ask questions and get instant, practical guidance 24/7.',
    card2_title: 'Smart Insights',
    card2_desc: 'Leverage agri-data, weather, and remote sensing signals.',
    card3_title: 'Privacy First',
    card3_desc: 'Your data stays secure and is used only to help you farm better.',
  },
  testimonials: {
  ...
  hi: {
    translation: {
      ...
      home: {
        ...
        about: {
          title: 'AgroWork के बारे में',
          subtitle: 'सतत और लाभदायक खेती के लिए एआई आधारित निर्णय सहायता',
          p1: 'AgroWork एक एकीकृत प्लेटफ़ॉर्म है जो मिट्टी अंतर्दृष्टि, फसल मार्गदर्शन, रोग पहचान, मौसम बुद्धिमत्ता और वित्तीय योजना को साथ लाता है—ताकि आप खेत पर तेज़ और बेहतर निर्णय ले सकें।',
          point1: 'आपके खेत के अनुसार डेटा-आधारित फसल और इनपुट सिफारिशें',
          point2: 'उपज और संसाधनों को अनुकूलित करने के लिए लागू मिट्टी और मौसम अंतर्दृष्टि',
          point3: 'आपकी भाषा में रोज़मर्रा के सवालों के लिए संवादात्मक सहायता',
          card1_title: 'एआई सहायता',
          card1_desc: 'सवाल पूछें और 24/7 तत्काल, उपयोगी मार्गदर्शन पाएं।',
          card2_title: 'स्मार्ट इनसाइट्स',
          card2_desc: 'कृषि-डाटा, मौसम और रिमोट सेंसिंग संकेतों का लाभ उठाएं।',
          card3_title: 'डेटा गोपनीयता',
          card3_desc: 'आपका डेटा सुरक्षित रहता है और केवल आपकी खेती बेहतर करने के लिए उपयोग होता है।',
        },
        how_it_works: {
